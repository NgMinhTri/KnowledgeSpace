...
{
    public class UpdatePermissionVmValidator : AbstractValidator<UpdatePermissionVm>
    {
        public UpdatePermissionVmValidator()
        {
            RuleFor(x => x.Permissions).NotNull()
               .WithMessage(string.Format(Messages.Required, nameof(UpdatePermissionVm.Permissions)));
