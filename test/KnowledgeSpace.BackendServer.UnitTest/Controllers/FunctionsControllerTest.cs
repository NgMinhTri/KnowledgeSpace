...
namespace KnowledgeSpace.BackendServer.UnitTest.Controllers
{
    public class FunctionsControllerTest
    {
        ...
        {
            var controller = new FunctionsController(_context, _mockLogger.Object);
            var result = await controller.PostFunction(new PostFunctionVm()
            {
        ...
        public async Task PutUser_ValidInput_Success()
        {
            ...
            await _context.SaveChangesAsync();
            var controller = new FunctionsController(_context, _mockLogger.Object);
            var result = await controller.PutFunction("PutUser_ValidInput_Success", new PostFunctionVm()
            {
                ParentId = null,
        ...
        public async Task PutUser_ValidInput_Failed()
        {
            ...
            var result = await controller.PutFunction("PutUser_ValidInput_Failed", new PostFunctionVm()
            {
                ParentId = null,
