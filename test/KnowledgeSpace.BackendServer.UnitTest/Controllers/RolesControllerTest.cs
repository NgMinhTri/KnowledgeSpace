...
namespace KnowledgeSpace.BackendServer.UnitTest.Controllers
{
    public class RolesControllerTest
    {
        ...
        {
            _mockRoleManager.Setup(x => x.Roles).Returns(_roleSources.AsAsyncQueryable());
            var rolesController = new RolesController(_mockRoleManager.Object);
        ...
        [Fact]
        public async Task GetRolePaging_NoFilter_ReturnSuccess()
        {
            _mockRoleManager.Setup(x => x.Roles).Returns(_roleSources.AsAsyncQueryable());
            var rolesController = new RolesController(_mockRoleManager.Object);
        ...
        [Fact]
        public async Task GetRolePaging_HasFilter_ReturnSuccess()
        {
            _mockRoleManager.Setup(x => x.Roles).Returns(_roleSources.AsAsyncQueryable());
            var rolesController = new RolesController(_mockRoleManager.Object);
        ...
        public async Task GetById_ThrowException_Failed()
        {
            ...
            var rolesController = new RolesController(_mockRoleManager.Object);
            var x = await Assert.ThrowsAnyAsync<Exception>(async () => await rolesController.GetById("test"));
        }
