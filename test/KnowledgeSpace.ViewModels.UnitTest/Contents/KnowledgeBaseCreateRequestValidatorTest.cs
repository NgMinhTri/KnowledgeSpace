...
namespace KnowledgeSpace.ViewModel.UnitTest.Contents
{
    ...
    {
        private PostKnowledgeBaseVmValidator validator;
        private PostKnowledgeBaseVm request;

        public KnowledgeBaseCreateRequestValidatorTest()
        {
            request = new PostKnowledgeBaseVm()
            {
                CaptchaCode = "abc",
            ...
            validator = new PostKnowledgeBaseVmValidator();
        }
